...
public class MainActivity extends Activity {
    ...
    private void setDiariesListView(ArrayList<Map<String,String>> items){  //设置适配器，显示列表
        SimpleAdapter simpleAdapter=new SimpleAdapter(this,items,R.layout.item,new String[]{Diaries.Diary._ID,Diaries.Diary.COLUMN_NAME_DATE,Diaries.Diary.COLUMN_NAME_TIME,Diaries.Diary.COLUMN_NAME_CONTENT},
                new int[]{R.id.textViewId,R.id.textViewDate,R.id.textViewTime,R.id.textViewContent});
        ListView listView=findViewById(R.id.list1);
    ...
    private ArrayList<Map<String,String>> getAll(){
        ...
        String[] projection={
                ...
                Diaries.Diary.COLUMN_NAME_TIME, //weather
    ...
    private ArrayList<Map<String,String>> ConvertCursorList(Cursor cursor){
        ...
        while(cursor.moveToNext()){
            ...
            map.put(Diaries.Diary.COLUMN_NAME_TIME,cursor.getString(2));
        ...
        switch (item.getItemId()){
            ...
            case R.id.action_update:
                ...
                itemView=info.targetView;
                    ...
                    textWeather=itemView.findViewById(R.id.textViewTime);
    ...
    private void Insert(String strDate,String strWeather,String strContent){  //添加
        SQLiteDatabase db=dbhelper.getReadableDatabase();
        ContentValues values=new ContentValues();  //键值对
        values.put(Diaries.Diary.COLUMN_NAME_DATE,strDate);
        values.put(Diaries.Diary.COLUMN_NAME_TIME,strWeather);
        ...
        new AlertDialog.Builder(this)  //dialog的一个子类
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        String strTime=((EditText)relativeLayout.findViewById(R.id.insertTime)).getText().toString();
                        String strContent=((EditText)relativeLayout.findViewById(R.id.insertContent)).getText().toString();
                        Insert(strDate,strTime,strContent);
    ...
    private void Delete(String strId){  //删除
        SQLiteDatabase db=dbhelper.getReadableDatabase();
    ...
    private void Update(String strId,String strDate,String strWeather,String strContent){  //编辑
        SQLiteDatabase db=dbhelper.getReadableDatabase();
    ...
    private void UpdateDialog(final String strId,final String strDate,final String strWeather,final String strContent){
        ...
        ((EditText)relativeLayout.findViewById(R.id.insertTime)).setText(strWeather);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        String strNewWeather=((EditText)relativeLayout.findViewById(R.id.insertTime)).getText().toString();
    ...
    private ArrayList<Map<String,String>> Search(String strDiarySearch){  //查询
        SQLiteDatabase db=dbhelper.getReadableDatabase();
        String[] projection={
                Diaries.Diary._ID,
                Diaries.Diary.COLUMN_NAME_DATE,
                Diaries.Diary.COLUMN_NAME_TIME,
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(items.size()>0){
                            ...
                            Toast.makeText(MainActivity.this,"该内容不存在",Toast.LENGTH_SHORT).show();
                        }
                    }
                })
                .setNegativeButton("取消", new DialogInterface.OnClickListener() {
